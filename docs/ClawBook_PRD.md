...
| 功能 | 說明 | 預計工時 | 優先級 | 實現狀態 |
|------|------|---------|--------|--------|
| **語音輸入** | 使用 Web Audio API 語音轉文字記錄日記，支援 10+ 語言 | 1-2 週 | ⭐⭐⭐⭐⭐ | ⏳ v1.3 開發中 |
| **情緒趨勢圖表** | 視覺化展示最近 30/60/90 天的情緒趨勢，支援 Recharts 互動圖表 | 2 週 | ⭐⭐⭐⭐⭐ | ⏳ v1.3 開發中 |
| **多語言支援** | 支援中文、英文等多語言 UI | 後續 | ⭐⭐⭐ | ⏳ v1.4 計劃 |
| **自動摘要** | AI 自動生成週/月摘要 | 後續 | ⭐⭐ | ⏳ v1.4 計劃 |
